...
RSpec.describe BooksController, type: :controller do
  ...
  let(:valid_attributes) {
    FactoryGirl.build(:book).test_attributes
  }

  let(:invalid_attributes) {
    FactoryGirl.build(:book, :invalid).test_attributes
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        FactoryGirl.build(:book, :another).test_attributes
      }
      ...
      it "updates the requested book" do
        ...
        book.reload
        expect(book.test_attributes).to eq(new_attributes)
      end
